...
def run_episodes_parallel(
    ...
    # Wrap classes with flop counting for all configs
    for config in configs:
        original_monty_class = config["monty_config"].get("monty_class")
        original_experiment_class = config.get("experiment_class")
        ...
        config["monty_config"]["monty_class"] = wrapped_monty
        config["experiment_class"] = wrapped_experiment
